        ...
        <form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }} class="space-y-6">
          ...
          <div class="bg-slate-800 border border-slate-700 rounded-lg p-5">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <div class="max-w-xs">
                  <TimezoneSelect value={timezone} disabled={!isAdmin} onchange={handleTimezoneChange} />
                </div>
          ...
          <div class="bg-slate-800 border border-slate-700 rounded-lg p-5">
            ...
            {#if scheduleType === 'weekly'}
              <ScheduleGrid schedule={weeklySchedule} disabled={!isAdmin} onchange={handleScheduleChange} />
            {:else}
              <CronScheduleInput schedule={cronSchedule} disabled={!isAdmin} onchange={handleCronScheduleChange} />
            {/if}
          </div>
          ...
          <div class="bg-slate-800 border border-slate-700 rounded-lg p-5">
            ...
            <ResourceSelector value={resourceSelector} disabled={!isAdmin} onchange={handleResourceSelectorChange} />
          </div>
